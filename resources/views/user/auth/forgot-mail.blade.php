...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0;  padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
  ...
  max-width: 560px;" class="container">
      ...
      font-family: sans-serif;" class="header">
              <img border="0" vspace="0" hspace="0" src="https://www.pathwaymedicalsupply.com/front/img/logo.jpg" width="200" height="58" alt="The Idea" title="The Idea" />
            </td>
          </tr>
          <tr>
      ...
      font-family: sans-serif;" class="paragraph">
               Hello {{$users->name}},<br> Please click the password reset button to reset your Password
            </td>
          </tr>
          <tr>
            <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
      ...
      padding-bottom: 5px;" class="button">
              <a href="{{url('user/forgot-password')}}/{{$users->email}}/{{$token->token}}" target="_blank" style="text-decoration: underline;">
          ...
          color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="{{url('user/forgot-password')}}/{{$users->email}}/{{$token->token}}">
            Change Password
          </a>
                    </td>
                  </tr>
